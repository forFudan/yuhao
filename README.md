...
- [1. 简介](#1-简介)
- [2. 下载和安装](#2-下载和安装)
  - [2.1. 各输入法 App](#21-各输入法-app)
    - [2.1.1. 举例](#211-举例)
  - [2.2. RIME 平台](#22-rime-平台)
    - [2.2.1. Windows / Macos / 安卓 / iOS 安装方法](#221-windows--macos--安卓--ios-安装方法)
    - [2.2.2. 具体文件介绍](#222-具体文件介绍)
  - [2.3. 方案特点](#23-方案特点)
    - [2.3.1. 提示快捷键](#231-提示快捷键)
    - [2.3.2. 单字拆分三重注解](#232-单字拆分三重注解)
    - [2.3.3. 增广常用字符集](#233-增广常用字符集)
    - [2.3.4. 一键切换字符集](#234-一键切换字符集)
    - [2.3.5. 使用 Z 键引导拼音反查](#235-使用-z-键引导拼音反查)
    - [2.3.6. 使用 Z 煞尾键输入特殊符号](#236-使用-z-煞尾键输入特殊符号)
    - [2.3.7. 全码词语屏蔽](#237-全码词语屏蔽)
- [3. 输入法规则介绍](#3-输入法规则介绍)
  - [3.1. 字根编码](#31-字根编码)
...
本方案可以在任何手机或电脑的输入法 App 上使用，比如百度、搜狗、落格、小小等。安装方法如下：

- 将 [/mabiao](https://github.com/forFudan/yuhao/tree/main/mabiao) 文件夹下的**yuhao.txt**下载到设备上。
...
#### 2.2.1. Windows / Macos / 安卓 / iOS 安装方法
