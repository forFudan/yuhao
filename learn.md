...
|      | S    | 艹({冓上}卌廾卅龷) |                                                 犬 a  臣 c  而 e  厂 h  馬({馬上}) m  辰 n  丂 o  二(ㄑ冫⺀) r  𠂇 u |
|      | D    | 石(丆)             |                          歹 d  丰 f  古 g  十 h  未 i  走 k  來 l  尤(尢) o  其 q  豕(𧰨) s  不 u  戊 w  西 x  雨 y |
|      | F    | 木(朩)             |                                                                                   三 a  爾 e  一(㇀) i  工 o  甫 u |
|      | G    | 王(⺩)              |                                                  大 d  革 e  匚(匸{畏下}𠥓) f  戈 g  面 i  車({專上}) j  酉 o  夫 u |
|      | H    | 土(耂)             |                                     長(髟镸) a  车 e  干 g  士({穀頭}) h  世 i  至 k  龶 n  末 o  示 s  兀 w  牙 y |
| 豎   | J    | 日(𫩏)              |                                                                               山 a  曰 e  田 i  黽({龜下}) m  早 o |
|      | K    | 虫                 |                 甲 a  贝 b  电 d  申 e  水(氺) h  见 i  冂({雋下}) j  鹵 l  門 m  由 o  上(丄{丄、}) s  攴 u  禺 y |
|      | L    | 口({黽上})         |                                                                                       {亞下}({亞中}) a  非 i  㗊 j |
|      | M    | 目                 | 小(⺌𣥂𡭔) a  齒 c  刂 d  骨 g  虎(虍{虍上}) h  貝 i  巾 j  見 k  皿 n  卜({龍右}{乍下}⺊) o  且({具上}) q  丨 s  罒 w |
|      | N    | 足(𧾷⻊)             |                                              冊(𠕁) c  鬥 d  黑 e  龰 h  止 i  〢({四竖}〣) s  尚 s  咼(冎) u  囗 w |
| 撇   | Q    | 竹({⺮右})          |                                           瓜 a  凡 f  殳 h  矢 i  几 j  僉 n  舟 o  丿 p  气 q  儿({荒下}) r  鱼 y |
|      | W    | 月({祭上}勹⺆𱼀)     |                                           乂(𠂭) a  身 e  生 g  川 h  隹 i  牛(𠂒⺧) n  缶 o  千 q  鬼({卑上}) u  𧘇 y |
|      | E    | 亻                 |                                      白 b  长 g  夂(攵) h  斤(⺁) i  爪(爫) k  壬 n  夭 o  欠 q  烏({烏上}) u  乌 w |
|      | R    | 金(釒)             |       彳 c  舌 e  風 f  向({囟框}{向框}) g  禾 h  {微上} i  匕 i  臼 j  夕 k  毛 m  犭 n  鳥({鳥上}) o  饣 s  入 u |
|      | T    | 片                 |                       卯({乐上}{卬左}) a  八({丿丨}) b  人 e  彡({两撇}{癶右}) i  钅 j  自 k  用 o  手(龵) u  魚 y |
|      | Y    | 心(忄)             |                                                       鸟({鸟上}) a  合 e  {爲下} i  豸 i  𠂤 i  九 j  冖(⺈) m  食 s |
...
| 折   | B    | 糸                 |                             刀 a  飛 e  子 i  己 j  母({母框}{互中}{毌框}) m  {鼠下} s  尸(𠃜⼫) s  又(癶ュスコ龴) u |
|      | V    | 厶                 |                                          乃 a  了 e  弓 g  巛(巜) h  乙(𠃌⺄乜㔾⺂) i  艮 n  皮 p  纟({纟上}) s  已 y |
|      | C    | 女                 |                                                                         巴 a  也 e  阝 f  韋({五下}) i  幺 o  予 u |
|      | X    | 彐                 |                                        马 a  屮(丩丱凵) c  爿 g  乚(𠃑𠃋𠄌) i  卩 j  力 l  廴 n  矛 o  巳 s  羽(习) u |
