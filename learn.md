...
字根图是查询字根的重要工具，初学者应当时常将它放在手边，以利用查询。以下为宇浩输入法繁简通打字根表。

| 分區 | 大碼 | 代表字根v          | 字根                                                                                                               |
| :--- | :--- | :----------------- | -----------------------------------------------------------------------------------------------------------------: |
| 橫   | A    | 扌(㐄ヰキ)         | 寸 c  亍 h  七 i  丌 j  丅 k  丁 n  耳 r  {于下} u  瓦 w                                                           |
|      | S    | 艹(卌{冓上}卅龷廾) | 犬 a  臣 c  而 e  厂 h  馬({馬上}) m  辰 n  丂 o  二(⺀ㄑ冫) r  𠂇 u                                                 |
|      | D    | 石(丆)             | 歹 d  古 g  十 h  西 i  走 k  來 l  丰 n  尤(尢) o  其 q  豕(𧰨) s  不 u  戊 w  雨 y                                |
|      | F    | 木(朩)             | 爾 e  一(㇀) i  三 n  工 o  甫 u                                                                                   |
|      | G    | 王(⺩)              | 大 d  革 e  匚({畏下}匸𠥓) f  戈 g  面 i  車({專上}) j  𡗗 n  酉 o  夫 u  弋 y                                       |
|      | H    | 土(耂)             | 長(镸髟) a  车 c  未 e  干 g  士({穀頭}) h  世 i  至 k  龶 n  末 o  示 s  兀 w  牙 y                               |
| 豎   | J    | 日(𫩏)              | 山 a  曰 e  田 i  黽({龜下}) m  早 o                                                                               |
|      | K    | 虫                 | 甲 a  贝 b  电 d  申 e  冂({雋下}) g  水(氺) h  鹵 l  門 m  由 o  上(丄{丄、}) s  攴 u  见 x  禺 y                 |
|      | L    | 口({黽上})         | {亞下}({亞中}) a  非 i  㗊 j                                                                                       |
|      | M    | 目                 | 小(𡭔𣥂⺌) a  齒 c  刂 d  骨 g  虎(虍{虍上}) h  貝 i  巾 j  見 k  皿 n  卜(⺊{龍右}{乍下}) o  且({具上}) q  丨 s  罒 w |
|      | N    | 足(𧾷⻊)             | 咼(冎) a  冊(𠕁) c  鬥 d  黑 e  龰 h  止 i  〢(〣{四竖}) s  尚 s  囗 w                                              |
| 撇   | Q    | 竹({⺮右})          | 殳 h  矢 i  几 j  凡 n  舟 o  丿 p  气 q  儿({荒下}) r  瓜 u  鱼 y                                                 |
|      | W    | 月(勹{祭上}𱼀⺆)     | 乂(𠂭) a  身 e  生 g  川 h  隹 i  牛(⺧𠂒) n  缶 o  千 q  鬼({卑上}) u  𧘇 y                                           |
|      | E    | 亻                 | 白 b  夂(攵) h  斤(⺁) i  爪(爫) k  壬 n  夭 o  欠 q  乌 w                                                          |
|      | R    | 金(釒)             | 彳 c  舌 e  風 f  向({囟框}{向框}) g  禾 h  {微上} i  匕 i  臼 j  夕 k  毛 m  僉 n  犭 n  鳥({鳥上}) o  饣 s  入 u |
|      | T    | 钅                 | 卯({卬左}{乐上}) a  八({丿丨}) b  人 e  长 h  彡({癶右}{两撇}) i  自 k  用 n  片 p  手(龵) u  魚 y                 |
|      | Y    | 心(忄)             | 鸟({鸟上}) a  合 e  豸 i  𠂤 i  九 j  冖(⺈) m  食 s  {爲下} w  烏({烏上}) w                                         |
| 捺   | U    | 言(訁)             | 丷(䒑ソ) a  羊(⺶) g  灬 i  火 o  丬 q  礻 s  广 u  亡({贏頭}) w                                                    |
|      | I    | 氵(𠁼ッ)            | 立 i  鹿({鹿上}) l                                                                                                 |
|      | O    | 宀                 | 讠 a  丶(乀) d  方 g  户(戶) h  亥 i  之 k  亠 o  辛 x  〇(㇣) o                                                   |
|      | P    | 疒                 | 麻 a  文 e  高({高上}) g  亦 i  衤 k  米 m  门 n  辶(⻍⻎) o  穴 u                                                   |
| 折   | B    | 糸                 | 刀 a  飛 e  尸(𠃜⼫) h  子 i  己 j  母({母框}{互中}{毌框}) m  {鼠下} u  又(コ癶ュス龴) u                             |
|      | V    | 厶                 | 乃 a  巛(巜) h  乙(⺄𠃌乜㔾⺂) i  了 l  艮 n  弓 o  皮 p  纟({纟上}) s  已 y                                          |
|      | C    | 女                 | 巴 a  阝 f  韋({五下}) i  幺 o  予 u  也 y                                                                         |
|      | X    | 彐                 | 马 a  屮(丩丱凵) c  爿 g  乚(𠃑𠄌𠃋) i  卩 j  力 l  廴 n  矛 o  巳 s  羽(习) u                                        |
...
必练：以下字根是最常用的50个简体字根，首先学习它们，对于打字的进步提升最大。请用输入法软件打出这个字根。
