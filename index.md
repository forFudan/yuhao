...
>[预览版 v2.0.0-rc.1 下载](https://github.com/forFudan/yuhao/releases/tag/v2.0.0-rc.1) · 
...
作者是荷兰银行信用风险高级量化模型验证师，鹿特丹伊拉斯姆斯大学访问学者，金融学博士。研究内容包括应用计量经济学、公司治理、薪酬设计、期权定价等。文学背景方面，作者曾为 2009 年上海市高考文科第二名，后为复旦大学古诗词协会会长。日常興趣愛好中包括阅读古典文學作品、诗词创作。本输入法是作者为了创作古風章回体小说而制作。因为作者的统计学和数据科学背景，故而追求算法科学，目標场景明確。本输入法整体性能均衡，部分指标优异。作者现使用本输入法进行文学创作，因此本输入方案、单字拆分、词库、输入平台功能等可以得到持续的日常维护和优化。
