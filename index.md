...
>[快速入门](./docs/cookbook) · 
>[详细教程](./docs/learn) · 
>[**光華**在线练习](./docs/practice) · 
>[**星陳**练习软件](https://github.com/forFudan/yuhao/releases/download/v3.1.0/yustar_practice_tool.exe)  
...
- **宇浩·星陳**方案采用了字根聚类自由排布模式。字型相似的字根会被聚拢在一道，自由排布在25个键位上。方案名取自《尚書大傳》之「明明上天，爛然星陳」。
