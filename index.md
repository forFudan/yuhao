...
- 面向大字集，全面覆盖 CJK 全字集 99000 多个漢字和部首（更新至 CJK 扩 I 区），可以用宇浩输入法打出所有生僻字。檢字方便，翻頁少，全字集中，候選項最多的碼位`DLYF`上只有16個候選字。
...
[**宇浩一代·卿雲**](./docs/v1/v1)方案是宇浩输入法的初世代方案，其名取自《尚書大傳》之「卿云烂兮，糺缦缦兮」。本世代已于2023年5月起停止更新维护，自然过渡到宇浩二代。

**宇浩二代·光華**方案是宇浩输入法的本世代方案，其名取自《尚書大傳》之「日月光華，旦復旦兮」。本世代现已稳定，将会持续更新维护。接下来的重点主要是修正拆分、优化 Rime 平台功能。

[**宇浩三代·星陳**](http://zhuyuhao.com/yustar/)方案是宇浩输入法的次世代方案，其名取自《尚書大傳》之「明明上天，爛然星陳」。本世代于2023年10月1日发布，具有强音托、强聚类、弱分区的特点。它同宇浩二代共用一套拆分表，只是字根大小码不同，故而两者并行维护，适用于不同偏好和需求的人群。
