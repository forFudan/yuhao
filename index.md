...
阅读[《快速入门指南》](./docs/cookbook)，十分钟了解宇浩输入法的基本规则和字根键位图。  
...
[阅读《快速入门指南》，十分钟了解宇浩输入法的基本规则和字根键位图。](./docs/cookbook)

[点击这里，使用字根练习小程序，直接学习最常用的50个字根。](./practice/practice_50.html)两个小时后，你就可以开始上手打字了。
...
要知道，宇浩输入法只使用了25个按键，也就是说四码的编码空间只有其他26键输入法的85.5%。但是宇浩输入法在常用繁简汉字下重码表现却是**最好**的。
