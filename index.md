...
- [教程](./docs/learn)详尽。在简快码的加持下，只用记住100个字根，就能基本输入最常用的500个漢字，其他字根可以边打边学。
...
- [**宇浩·星陳**](http://zhuyuhao.com/yustar/)方案（公测中）采用了字根聚类自由排布模式。字型相似的字根会被聚拢在一道，自由排布在25个键位上。方案名取自《尚書大傳》之「明明上天，爛然星陳」。
