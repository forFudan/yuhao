...
>[内测版v2.0.0-alpha.beta下载（四重注解）](https://github.com/forFudan/yuhao/releases/tag/v2.0.0-alpha.beta)  
>[快速入门](./docs/cookbook) ·
>[详细教程](./docs/learn) ·
>[在线练习](./docs/practice) ·
...
宇浩输入发支持繁简通打，并不代表它牺牲了只打简体或只打繁体的性能。宇浩输入法不仅适合只输入简体，也是当前市面上最优秀的繁体输入法之一。它在简体、繁体文本下的表现分别有多好呢？不妨看一看下面的数据：
