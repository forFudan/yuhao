...
宇浩输入法目前有两套并行方案，设计理念一致，单字拆分统一，字根分布不同。新手可根据自己的喜好选择一个。
...
[**卿雲爛兮**](https://zhuyuhao.com/yujoy)是宇浩输入法的**乱序单编**衍生方案。方案名取自《尚書大傳》之「卿雲爛兮，糺縵縵兮」。取码规则共两条：
